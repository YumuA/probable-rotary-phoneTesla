        ...
        return(
            ...
            <div className="z-30 relative h-screen flex flex-col">
              ...
              <footer className=' flex flex-grow flex-nowrap justify-end flex-col pb-20'>
                <div>
                    <a href={btnhref} target="_Blank" className='border-[3px] border-white backdrop-blur-xl text-sm rounded font-medium text-white px-10 py-2 inline-block hover:bg-white hover:text-black transition-colors '>
                        {btn}</a>
                </div>
              </footer>
            ...
            <div className='absolute top-0 bottom-0 h-screen z-10 w-full'>
