...
class Abme extends React.Component{
    constructor(props){
        super(props);
        this.state = {
        ...
        return(
            ...
            <div className="z-30 relative h-screen flex flex-col">
              ...
              <footer className=' flex flex-grow flex-nowrap justify-end flex-col pb-20'>
                <div>
                    <a href={btnhref} className='border-[3px] border-white backdrop-blur-xl text-sm rounded font-medium text-white px-10 py-2 inline-block hover:bg-white hover:text-black transition-colors ' target="_Blank">
                        {btn}</a>
                </div>
              </footer>
